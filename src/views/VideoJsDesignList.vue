<template>
    <div>
        ...
        <div>
            <video-playering ref="pVideoPlayering" :option="playeringOptions"
                            :listOption="playingList"
                            @playering="onPlayering"/>
...
import VideoPlayering from '@/components/VideoPlayering.vue'
...
export default {
    ...
    methods: {
       async onPlayer(player){
        ...
        async onPlayering(playering){
            this.playering = playering
            //this.responseing = await this.playering(this.playeringOptions)        
        },
        anotherPlay(){
            this.$refs.pVideoPlayering.playVideo()
            //this.$refs.vdpg.playering.play()
            /*    
            if(this.responseing)
                this.onPlayering()
            */    
